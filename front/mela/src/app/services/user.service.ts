...
export class UserService {
  ...
  //get all users
  getAllUsers() {
    return this.http.get('https://mela-sigma.vercel.app/users')
  }

  //get a user by Id
  getUserById(id: string) {

    return this.http.get<{success: Boolean, data: User}>(`https://mela-sigma.vercel.app/api/v1/users/${id}`)
  ...
  loginUser(data: LoginUser) {
    ...
    this.http.post("https://mela-sigma.vercel.app/api/v1/users/login", data).subscribe(
  ...
  registerUser(data: RegisterUser) {
    ...
    this.http.post("https://mela-sigma.vercel.app/api/v1/users/register", data).subscribe(
      (result: any)=>{
        this.saveUserDataLocalStorage(result.data)
  ...
  editImage(image: File){
    ...
    return this.http.put("https://mela-sigma.vercel.app/v1/users/image", image);

  }

  editProfile(editForm: EditProfile){

    return this.http.put("https://mela-sigma.vercel.app/v1/users/", editForm);
  ...
  paymentInitialize(id:string, donationForm: any){
    ...
    return this.http.post(`https://mela-sigma.vercel.app/api/v1/campaigns/${id}/payment`, body)
  }

  getBanks(){

    return this.http.get(`https://mela-sigma.vercel.app/api/v1/campaigns/banks`)
  }

  withdrawal(transferData: transfer){

    return this.http.post(`https://mela-sigma.vercel.app/api/v1/campaigns/transfer/${this.currentUser.value._id}`, transferData)
  }
